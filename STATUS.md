...
**State:** Seed scaffolded. Buildable paper skeleton exists with central bibliography and central house-style symlinks.
**Next action:** Verify sources for the legal/ethics and rater-analogy claims before adding citations. Then decide whether the target is a short methodological note, an ethics-facing position paper, or a linguistics-methodology article.
**Blocker:** None.
